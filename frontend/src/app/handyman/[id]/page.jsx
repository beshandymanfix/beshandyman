            ...
            <div className="flex-shrink-0 w-full md:w-auto">
              <div className="bg-zinc-950 p-6 rounded-xl border border-zinc-800 text-center">
                ...
                {user && user._id === handyman._id ? (
                  <Link href="/tasker-profile" className="block w-full mt-4 bg-zinc-800 text-white font-bold px-8 py-3 rounded-lg hover:bg-zinc-700 transition-colors text-center">
                    Edit Profile
                  </Link>
                ) : (
              ...
              {handyman.skills && handyman.skills.length > 0 ? (
                <div className="space-y-4">
                  {handyman.skills.map((skill, index) => (
                    <Link key={index} href={`/handyman/${handyman._id}/skill/${encodeURIComponent(skill)}`} className="block hover:bg-zinc-800/30 transition-colors rounded-xl">
